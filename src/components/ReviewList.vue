  ...
  <div class="w-full">
    ...
    <div v-else class="flex flex-col gap-5">
      ...
      >
        <!-- Red accent line -->
        <div
          class="absolute left-0 top-0 w-1 h-full bg-red-600 transform scale-y-0 group-hover:scale-y-100 transition-transform origin-top"
        ></div>
        ...
        <div class="flex justify-between items-start gap-4 mb-4">
          ...
          <div class="flex items-center gap-4 flex-1">
            <!-- Avatar -->
            <div
              class="w-12 h-12 rounded-full bg-red-600 text-white flex items-center justify-center text-xl font-bold flex-shrink-0"
            >
